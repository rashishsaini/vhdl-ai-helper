...
|---------|------|--------|---------------------|
| `wait until X for T` | ✅ | ⚠️ | Polling loop |
| Unicode in strings | ❌ | ✅ | ASCII only |
| `process(all)` | ✅ | ✅ | Use for VHDL-2008 |
| Non-static aggregates | ❌ | ✅ | Use functions |
| `real'image()` | ✅ | ✅ | Both support |
...
-- For |x| <= 1.35: Compute σ(x) = 1/(1 + e^(-x))
...
--   2. Accumulate weight × delta products
...
-- Stage 2: Multiply lr × gradient (Q2.13 × Q10.26 = Q12.39)
...
-- Keep operands at 18×25 or smaller for single DSP
-- Q2.13 × Q2.13 fits perfectly (16×16)
```
...
|---|--------|----------|--------|-------|
| 1 | weight_register_bank | Storage | ✅ | Verified |
| 2 | gradient_register_bank | Storage | ✅ | Verified |
| 3 | forward_cache | Storage | ✅ | Verified |
| 4 | input_buffer | Storage | ✅ | Verified |
| 5 | activation_unit | Combinational | ✅ | Verified |
| 6 | activation_derivative_unit | Combinational | ✅ | Verified |
| 7 | saturation_unit | Combinational | ✅ | Verified |
| 8 | rounding_saturation | Pipelined | ✅ | Verified |
| 9 | bias_adder | Pipelined | ✅ | Verified |
| 10 | accumulator | FSM | ✅ | Verified |
| 11 | reciprocal_unit | FSM | ✅ | Verified |
| 12 | sqrt_unit | FSM | ✅ | Verified |
| 13 | exp_approximator | Pipelined | ✅ | Verified |
| 14 | log_approximator | Pipelined | ✅ | Verified |
| 15 | division_unit | FSM | ✅ | Verified |
| 16 | sigmoid_unit | FSM | ✅ | Verified |
| 17 | tanh_unit | FSM | ✅ | Verified |
| 18 | mac_unit | Pipelined | ✅ | Verified |
| 19 | dot_product_unit | FSM | ✅ | 11/11 |
| 20 | vector_accumulator | FSM | ✅ | 11/11 |
| 21 | error_calculator | Combinational | ✅ | Verified |
| 22 | delta_calculator | Combinational | ✅ | 24/24 |
| 23 | gradient_calculator | FSM | ✅ | 10/10 |
| 24 | weight_updater | Pipelined | ✅ | 17/17 |
| 25 | error_propagator | FSM | ✅ | 11/11 |
| 26 | forward_datapath | Sub-Top | ⬜ | Pending |
| 27 | backward_datapath | Sub-Top | ⬜ | Pending |
| 28 | weight_update_datapath | Sub-Top | ⬜ | Pending |
| 29 | neuron_training_top | Top | ⬜ | Pending |
