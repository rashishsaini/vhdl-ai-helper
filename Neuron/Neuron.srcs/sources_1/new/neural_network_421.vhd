...
end entity neural_network_421;



architecture rtl of neural_network_421 is
    ...
    -- Layer 2 weights for error propagation

    signal l2_weight_0, l2_weight_1 : signed(DATA_WIDTH-1 downto 0);
...
begin
    ...
    layer1_neuron0 : entity work.single_neuron
        ...
        port map (
            ...
            input_index     => resize(input_index, 4),
    ...
    layer1_neuron1 : entity work.single_neuron
    ...
    layer2_output : entity work.single_neuron
            ...
            if rst = '1' then
                ...
                case l2_input_state is
                    ...
                    when L2_IDLE =>
                        ...
                        if l1_n0_fwd_done = '1' and l1_n1_fwd_done = '1' then
            ...
            if rst = '1' then
                ...
                case l2_weight_read_state is
                    ...
                    when WR_READ_W0 =>
                        ...
                        -- Weight 0 arrives this cycle, capture it

                        l2_weight_for_prop <= l2_weight_0;
                    ...
                    when WR_READ_W1 =>
                        ...
                        -- Weight 1 arrives this cycle, capture it

                        l2_weight_1_reg <= l2_weight_0;  -- Reusing same port
    ...
    -- Assign l2_weight_1 from registered value

    l2_weight_1 <= l2_weight_1_reg;
    ...
    begin
        ...
        diff := resize(target, DATA_WIDTH+1) - resize(l2_a, DATA_WIDTH+1);
    ...
    -- l1_n0_error = W_L2[0] × δ_L2

    -- l1_n1_error = W_L2[1] × δ_L2
    ...
    -- Fix #6: Combined update done signal

    upd_done     <= l1_n0_upd_done_internal and l1_n1_upd_done_internal and l2_upd_done_internal;
