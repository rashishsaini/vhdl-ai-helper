...
Read the following files and assess what type of assistance is needed:
- VHDL source file: [SPECIFY_PATH]
- Testbench (if exists): [SPECIFY_PATH]  
- Vivado log file: [SPECIFY_PATH]
