...
1. **VHDL design file path**: (Required - e.g., `./rtl/my_design.vhd`)
2. **Testbench file path**: (Optional - I can generate one if needed)
3. **Maximum iterations**: (Optional - default is 5)
